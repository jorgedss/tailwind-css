...
const fileItem = tv({
  slots: {
    ...
    icon: 'rounded-full border-4 p-2 border-violet-100 bg-violet-200 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500',
    deleteButton: '',
  },
      ...
      {state === 'error' ? (
        <div className="flex flex-col flex-1 items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-error-600 text-sm dark:text-error-500">
              {name}
            </span>
          </div>
          ...
          <button
            type="button"
            className="text-error-700 text-sm font-semibold dark:text-error-400 dark:hover:text-error-300 hover:text-error-900"
          >
            Try again
          </button>
        </div>
        ...
        <div className="flex flex-col flex-1 items-start gap-1">
          ...
          <div className="w-full flex items-center gap-3">
            <div className="h-2 flex-1 bg-zinc-100 rounded-full dark:bg-zinc-600">
              <div
                className="h-2 bg-violet-600 rounded-full dark:bg-violet-400"
